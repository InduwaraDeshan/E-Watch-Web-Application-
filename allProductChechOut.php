        ...
        <div class="row ">
            ...
            ?>
                ...
                <div class="col-10 offset-1 bg-white ">
                    ...
                    <div class="row">
                        <div class="col-12  shadow rounded mb-3">
                            <div class="row">
                                                        ...
                                                        <div class="col-md-12 mt-3 mb-3">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 col-md-6 text-end">
                                                                    <span class="fw-bold fs-5 text-black-50"> Rs. <?php echo ($product_data["price"] * $cart_dt["qty"]) + $ship ?>.00</span>
                                                                </div>
                                ...
                                <div class="col-12 col-lg-3 shadow bg-light">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <span class="fs-6 fw-bold">Shipping&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                RS.</span>
                                        </div>

                                        <div class="col-6 text-end">
                                            <input class="fs-6 fw-bold border-0" type="text" value=" <?php echo $shipping ?>" disabled id="shipping">
                                        </div>
                                        ...
                                        <div class="col-6 mt-2 text-end">
                                            ...
                                            <input class="fs-5 fw-bold border-0" type="text" value=" <?php echo $total + $shipping ?>" disabled id="payment">
                                        </div>
