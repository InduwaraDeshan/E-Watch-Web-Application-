    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            ...
            if (t == "success") {
                ...
                alert("Your account has been blocked.Try again later...");
            } else {
...
function productView(id) {
    ...
    var productViewModal = document.getElementById("productViewModal");
    pd = new bootstrap.Modal(productViewModal);
    pd.show();
