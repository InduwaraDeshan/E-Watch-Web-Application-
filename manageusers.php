        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-10  shadow">
                ...
                <div class="col-12 bg-light text-center ">
                    <h2 class="text-black-50 fw-bold ">Manage All Users</h2>
                </div>



                <div class="col-12 mb-3 border border-1 border-dark">
                    <div class="row">
                        <div class="col-2 col-lg-1 bg-secondary py-2 text-end text-center">
                            <span class="fs-4 fw-bold text-white">#</span>
                        </div>
                        <div class="col-2  bg-light py-2 d-none  d-lg-block text-center">
                            <span class="fs-4 fw-bold ">Profile Image</span>
                        </div>
                        <div class="col-4 col-lg-2 bg-secondary py-2 text-center ">
                            <span class="fs-4 fw-bold text-white">User Name</span>
                        </div>
                        <div class="col-4 col-lg-2 bg-light py-2 d-lg-block text-center">
                            <span class="fs-4 fw-bold ">Email</span>
                        </div>
                        <div class="col-2  bg-secondary py-2 d-none d-lg-block  text-center">
                    ...
                    <div class="col-12 mb-3 border border-1 border-dark ">
                        <div class="row">
                            ...
                            <div class="col-2 col-lg-1 bg-white py-2  d-grid">
                                ...
                                if ($s == "1") {
                                ?>
                                    <button class="btn btn-danger" onclick="blockuser(<?php echo $user_data['id']; ?>);" id="blockuser<?php echo $user_data['id']; ?>">Unblock</button>
                                <?php
                                } else {
                                ?>
                                    <button class="btn btn-danger" onclick="blockuser(<?php echo $user_data['id']; ?>);" id="blockuser<?php echo $user_data['id']; ?>">Block</button>
                                <?php
                                }
                                ?>
