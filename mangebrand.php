                        ...
                        <div class="col-10">
                            ...
                            <div class="col-12 mb-3 bg-light ">
                                <div class="row g-2">
                                    ...
                                    ?>
                                        ...
                                        <div class="col-12 col-lg-4 border border-danger" style="height: 50px;">
                                            <div class="row">
                                                ...
                                                <div class="col-4 border-start border-secondary text-center mt-2">
                                                    <label for="form-label fs-4" onclick="deleteFromBrand(<?php echo $brand_data['id']; ?>);"><i class="bi bi-trash"></i></label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-lg-4 border border-danger bg-secondary" onclick="addNewbrand();" style="height: 50px;">
                                        <div class="row">
                                            <div class="col-8 mt-2 text-center">
                                                <label class="form-label fw-bold fs-5 text-white ">Add New Brand</label>
                                            </div>
                                            <div class="col-4 border-start border-secondary text-center mt-2">
                                                <label class="form-label fs-4"><i class="bi bi-shield-fill-plus"></i></label>
                                            </div>
